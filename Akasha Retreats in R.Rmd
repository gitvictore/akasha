...
**Most participants were women (58.7%)** with an **average age of 42 years** (SD = 9.06, range 24–62). **Education was high**: over half had a bachelor's (30.2%) or master's (25.4%) degree. The sample was **internationally diverse; most originated from Brazil (30.2%)**, followed by the United Kingdom (19.0%), and United States (17.5%).
...
tbl <- table(base_clean$PastAya_bin,
...
for (i in seq_len(ncol(slim_results_nat))) {
  k <- k %>% column_spec(i, extra_css = "font-size: 0.95em;")
}
