...
### Participants' Intentions by Past Ayahuasca (Descriptive Statistics)
The horizontal bar chart displays the frequency of prior ayahuasca experience among participants at *Baseline* (*n*=63). The largest group reported taking ayahuasca *more than 10 times (23 participants, 37%)*, followed by those who had never taken it (13 participants, 21%). Smaller proportions had taken it once (17%), 6–10 times (14%), or 2–5 times (11%). Overall, the sample includes both ayahuasca-naive and experienced participants, with a notable concentration at both extremes of experience.
## Chart 1: Participants' Intentions by Prior Experience with Ayahuasca
...
ggplot(freq, aes(x = PastAyahuasca, y = n)) +
  ...
  labs(
    ...
    y = "# Participants",
    title = "Frequency of Prior Ayahuasca Experience"
  ) +
  theme_minimal(base_size = 14) +
  theme(
    panel.grid.minor = element_blank(),
...
```{r ayahuasca-by-intention-plotly, echo=FALSE, fig.align='center'}
...
ggplot(intention_freq, aes(x = Intention, y = PastAyahuasca, fill = prop)) +
  ...
  labs(
    x = "Ceremony Intention",
    y = "Prior Ayahuasca Experience",
    fill = "Proportion",
    title = "Distribution of Intentions by Prior Ayahuasca Experience"
  ) +
  theme_light(base_size = 13) +
  theme(
