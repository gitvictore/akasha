...
Immediately following the retreat, participants received a *Post-Retreat* questionnaire, which captured their immediate experiences and perceived effects after the ceremonies. This survey repeated the nature and social connectedness measures from *Baseline*, allowing comparison of pre- and post-retreat responses. Additional questions were asked about specific post-ceremonial effects (e.g., feelings of peace, connectedness, emotional balance, and insights about personal challenges). Participants also rated the importance of specific aspects of the ceremonial setting, including presence of shamanic figures, music, group rituals, and the physical environment, on a similar 5-point Likert scale. Open-ended items solicited participants to share impactful moments and the primary emotion they experienced post-retreat.

The final *One-Month* questionnaire, conducted one month after the retreat, reassessed participants' recent well-being, nature and social connectedness, and mental health status, using identical questions from the previous questionnaires.
