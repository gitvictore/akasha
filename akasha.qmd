---
title: "Wellbeing and Connectedness After Ayahuasca: Findings from a Longtitudinal Pilot Study in Petrópolis, Brazil"
author:
...
Indeed, participants who had attended 6 or more previous ceremonies (*n* = 31) were significantly more likely to report spiritual growth as their primary intention compared to those with less experience. According to a Fisher's Exact Test, the odds of choosing a spiritual motivation were **3.24 times higher** in the high-experience group (OR = 3.24, 95% CI: 1.04 = 10.67, *p* = .041\*). This statistically significant association suggests that spiritual intentions may become more prominent with continued engagement in ayahuasca ceremonies. While the wide confidence interval reflects the modest sample size, this significant finding merits further exploration in future studies.

```{r fisher test intention, include=FALSE, echo=FALSE}
