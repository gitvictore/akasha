---
title: "Aldeia Akasha: Ayahuasca, <br>Wellbeing, and Connectedness"
author:
...
format:
  html:
    output-file: Akasha-Retreats-in-R.html
    toc: true
    toc-depth: 4
    toc-expand: 2
    self-contained: true
...
```{r fisher test intention, echo=FALSE}
...
knitr::kable(summary_tbl, format="html", align="lrr", escape = FALSE, col.names = c("Ceremonial Aspect", "Mean (1 – 5)", "% Very/Extremely<br>Important")) %>%
  ...
  kableExtra::footnote(
    general = "<i>n</i> = 46, including one participant who did not finish <i>Baseline</i> but included here for descriptive purposes",
    escape = FALSE)
